...
| Code review | Zoe 🧪 / Mal 🏗️ | Review PRs, check quality, approve or reject |
| Architecture, scope, design | Mal 🏗️ | Data flow decisions, API contracts, PRD decomposition |
| AI-assisted workflow definitions | Wash ⚙️ | `.github/aw/` markdown files for agentic workflows |
| Issue triage | Mal 🏗️ | Analyze issues, assign `squad:{member}` labels |
